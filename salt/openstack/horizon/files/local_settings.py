...
DEBUG = {{ salt['pillar.get']('horizon:DEBUG') }}
TEMPLATE_DEBUG = {{ salt['pillar.get']('horizon:TEMPLATE_DEBUG') }}
...
OPENSTACK_HOST = "{{ nova_controller[0] }}"
OPENSTACK_KEYSTONE_URL = "http://%s:5000/v2.0" % OPENSTACK_HOST
OPENSTACK_KEYSTONE_DEFAULT_ROLE = "{{ salt['pillar.get']('horizon:OPENSTACK_KEYSTONE_DEFAULT_ROLE') }}"
...
COMPRESS_OFFLINE = {{ salt['pillar.get']('horizon:COMPRESS_OFFLINE') }}
